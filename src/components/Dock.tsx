  ...
  const mobileChannels = [
    {
      ...
      url: instagramUrl,
      bgClass: 'bg-gradient-to-tr from-[#fdf497] via-[#fd5949] via-[#d6249f] to-[#285AEB]',
    ...
    },
    {
      ...
      url: appleMusicUrl,
      bgClass: 'bg-gradient-to-tr from-[#FC3C44] via-[#F94C57] to-[#FA2D55]',
      iconClass: 'fill-white',
      icon: (
        ...
        {desktopApps.map((app) => (
          <div key={app.id} className="relative group">
            ...
            >
              ...
              {/* 2D Pictogram Icon */}
              <div className={`relative z-10 transition-all duration-200 group-hover:scale-105 flex items-center justify-center drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] ${
                app.id === 'direction' 
